...
import com.mukangulol.application3.adapters.UpcomingAdapter;
...
RecyclerView recyclerView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        List<UpcomingModel.Event> event = globalController.retrieveUpcoming();
        UpcomingAdapter adapter = new UpcomingAdapter(getContext(), event);
